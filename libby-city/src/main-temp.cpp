...
{
  GLubyte floorTexture[texHeight][texWidth][3];
  GLubyte *loc;
  int s, t;
  ...
  glTexImage2D   (GL_TEXTURE_2D, 0, 3, texWidth, texHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, floorTexture);
